...
public class UpdateStaff extends javax.swing.JFrame {
    ...
    public UpdateStaff(String ID,String Value){
        initComponents();
        id=ID;
        value=Value;
        Toolkit tk=Toolkit.getDefaultToolkit();
    ...
    private void initComponents() {
        ...
        jSearch.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/search staff.png"))); // NOI18N
        ...
        getContentPane().add(jSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(990, 490, -1, -1));
    ...
    private void jSearchMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchMouseClicked
        ...
        String check="update";
        StaffList list = new StaffList(id,check,submit_check,frame,label,label2,label3,label4,label5,label6,menubar);
    ...
    private void jSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSaveMouseClicked
        ...
        PreparedStatement st=null;
        con=Link.getConnection();
        String sql="update staff set name=?,surname=?,age=?,job=?,gender=?,blood=?,address=?,city=?,phone=?,NIC=?,email=?,joining=?,full_name=? where id='"+value+"'";
        try{
            st=con.prepareStatement(sql);
    ...
    private void jSubmitMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSubmitMouseClicked
        ...
        PreparedStatement st=null;
        con=Link.getConnection();
        String sql="update staff set photo=? where id='"+value+"'";
        try{
            st=con.prepareStatement(sql);
    ...
    private void jPreviousMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPreviousMouseClicked
        ...
        ResultSet rs = null;
        con = Link.getConnection();
        String sql="select * from staff where id='"+value+"'";
        try{
            st=con.prepareStatement(sql);
            rs=st.executeQuery();
