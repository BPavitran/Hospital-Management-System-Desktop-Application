 ...
 * @author Pavi
 */
public class WardPatient extends javax.swing.JFrame {
    String first;
    String last;
    String test;
    String old;
    ...
    int x,y;
    /**
     * Creates new form WardPatient
     */
    public WardPatient() {
        initComponents();
    }
    
    public WardPatient(String ID){
        initComponents();
    ...
    public WardPatient(String ID,String Value) {
        initComponents();
        id=ID;
        value=Value;
        Toolkit tk=Toolkit.getDefaultToolkit();
        ...
        if(rs.next()){
            ...
            jBed.setText(rs.getString("bed_no"));
        }
        }
        catch(Exception e){
            JOptionPane.showMessageDialog(null,e);
    ...
    private void initComponents() {
        ...
        jDischarge = new javax.swing.JLabel();
        ...
        jDischargePanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Ward", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Raleway SemiBold", 0, 13), new java.awt.Color(11, 159, 207))); // NOI18N
        ...
        jDischargePanel.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 70, -1, -1));

        jLabel17.setFont(new java.awt.Font("Raleway SemiBold", 0, 13)); // NOI18N
        jLabel17.setForeground(new java.awt.Color(11, 159, 207));
        jLabel17.setText("Current Ward");
        jDischargePanel.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 30, -1, -1));

        jWard.setEditable(false);
        jDischargePanel.add(jWard, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 30, 140, 30));

        jBed.setEditable(false);
        jDischargePanel.add(jBed, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 70, 140, 30));

        jDischarge.setBackground(new java.awt.Color(11, 159, 207));
        jDischarge.setForeground(new java.awt.Color(255, 255, 255));
        jDischarge.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jDischarge.setText("Discharge");
        jDischarge.setOpaque(true);
        jDischarge.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseMoved(java.awt.event.MouseEvent evt) {
                jDischargeMouseMoved(evt);
            }
        });
        jDischarge.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jDischargeMouseClicked(evt);
            }
        });
        jDischargePanel.add(jDischarge, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 120, 61, 23));

        getContentPane().add(jDischargePanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 330, 410, 170));
        ...
        jTestPanel.add(jLabel24, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 30, 50, -1));
        ...
        getContentPane().add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 420, -1, -1));
        ...
        jLabel25.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/wardPatientIcon.png"))); // NOI18N
        ...
        jLabel28.setText("Ward Patients Details");
        getContentPane().add(jLabel28, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 40, 370, 50));
    ...
    int count=0;DefaultListModel list=new DefaultListModel();
    private void jDischargeMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jDischargeMouseMoved
        // TODO add your handling code here:
        Cursor cur1=new Cursor(Cursor.HAND_CURSOR);
        jDischarge.setCursor(cur1);
    }//GEN-LAST:event_jDischargeMouseMoved

    private void jDischargeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jDischargeMouseClicked
        // TODO add your handling code here:
        Connection con = null;
        PreparedStatement st=null;
        con = Link.getConnection();
        String sql="update patient_stage set patient_type=? ,ward_no=?, bed_no=?, accept=? where patient_id="+value;
        try{
            st=con.prepareStatement(sql);
            st.setString(1,"Outdoor");
            st.setString(2,"0");
            st.setString(3,"0");
            st.setString(4,"No");
            st.executeUpdate();
            JOptionPane.showMessageDialog(null,"Patient is discharged");
            
            jDischargePanel.setVisible(false);
        }
        catch(Exception e){
            JOptionPane.showMessageDialog(null,e);
        }
    }//GEN-LAST:event_jDischargeMouseClicked
    ...
    private void jSearchMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSearchMouseClicked
        ...
        WardPatientList list = new WardPatientList(id,frame,label,label2,label3);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WardPatient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WardPatient().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel jDischarge;
