 ...
 * @author Pavi
 */
public class DoctorProfileView extends javax.swing.JFrame {
    String filename;
    byte[] person_image;
    byte[] imageBytes;
    String id;
    ...
    /**
     * Creates new form DoctorProfileView2
     */
    public DoctorProfileView() {
        initComponents();
    }
    
    public DoctorProfileView(String ID){
        initComponents();
    ...
    private void jUpdateProfileMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jUpdateProfileMouseClicked
        // TODO add your handling code here:
        DoctorProfileUpdate update = new DoctorProfileUpdate(id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DoctorProfileView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DoctorProfileView().setVisible(true);
            }
        });
    }
