...
public class InsertDoctor extends javax.swing.JFrame {
    ...
    public InsertDoctor(String ID) {
        ...
        try{
        st=con.prepareStatement("select max(id) as last_id from doctor");
        rs = st.executeQuery();
        if(rs.next()){
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 510, -1, -1));
        ...
        getContentPane().add(jSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(1130, 500, -1, -1));
        ...
        getContentPane().add(jPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(980, 530, 140, 30));
    ...
    private void jSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSaveMouseClicked
        ...
        PreparedStatement st=null;
        con=Link.getConnection();
        String sql="insert into doctor(id, name, surname, age, specialization, gender, blood, address, city, phone, NIC, email, joining,username,password,photo,full_name) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        try{
