 ...
 * @author Pavi
 */
public class ViewPatientList extends javax.swing.JFrame {
    String id;
    JFrame frame;
    JLabel label;
    JLabel label2;
    /**
     * Creates new form ViewPatientList2
     */
    public ViewPatientList() {
        initComponents();
    }
    
    public ViewPatientList(String ID,JFrame Frame,JLabel Label,JLabel Label2) {
        initComponents();
        id=ID;
        frame=Frame;
        label=Label;
        ...
        String sql="select name,surname,phone from patient where id in (select patient_id from patient_doctor where doctor_id=?)";
        try{
    ...
    private void jSelectMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSelectMouseClicked
        ...
        ViewPatient view = new ViewPatient(id,ID);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewPatientList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewPatientList().setVisible(true);
            }
        });
    }
