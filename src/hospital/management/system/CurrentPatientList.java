 ...
 * @author Pavi
 */
public class CurrentPatientList extends javax.swing.JFrame {
    String id;
    JFrame frame;
    JLabel label;
    JLabel label2;
    ...
    /**
     * Creates new form CurrentPatientList2
     */
    public CurrentPatientList() {
        initComponents();
    }
    
    public CurrentPatientList(String ID,JFrame Frame,JLabel Label,JLabel Label2,JLabel Label3) {
        initComponents();
        id=ID;
        frame=Frame;
        label=Label;
        ...
        String sql="select name,surname,phone from patient where id in (select patient_id from patient_doctor where doctor_id=? and done=? and date=?)";
        try{
        st=con.prepareStatement(sql);
        st.setString(1,id);
        st.setString(2,"No");
        st.setString(3,java.time.LocalDate.now().toString());
        rs=st.executeQuery();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 90, -1, 90));
    ...
    private void jSelectMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSelectMouseClicked
        ...
        CurrentPatient current = new CurrentPatient(id,ID);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CurrentPatientList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CurrentPatientList().setVisible(true);
            }
        });
    }
