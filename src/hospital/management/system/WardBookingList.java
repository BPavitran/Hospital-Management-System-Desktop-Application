 ...
 * @author Pavi
 */
public class WardBookingList extends javax.swing.JFrame {
    String id;
    JFrame frame;
    JLabel label;
    JLabel label2;
    ...
    String first;
    /**
     * Creates new form WardBookingList
     */
    public WardBookingList() {
        initComponents();
    }
    
    public WardBookingList(String ID,JFrame Frame,JLabel Label,JLabel Label2,JPanel Panel,String First) {
        initComponents();
        id=ID;
        frame=Frame;
        label=Label;
        ...
        String sql="select name,surname,phone from patient where id in (select patient_id from patient_stage where accept=?)";
        try{
    ...
    private void jNameKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jNameKeyTyped
        ...
        ResultSet rs = null;
        con = Link.getConnection();
        String sql="select name,surname,phone from patient where name like '"+start+"%' and id in (select patient_id from patient_stage where accept=?)";
        try{
            st=con.prepareStatement(sql);
            st.setString(1,"Yes");
            rs=st.executeQuery();
    ...
    private void jSelectMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSelectMouseClicked
        ...
        WardBooking ward = new WardBooking(id,ID);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WardBookingList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WardBookingList().setVisible(true);
            }
        });
    }
