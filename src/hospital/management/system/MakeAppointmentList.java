 ...
 * @author Pavi
 */
public class MakeAppointmentList extends javax.swing.JFrame {
    String id;
    JFrame frame;
    JLabel label;
    JLabel label2;
     ...
     */
    public MakeAppointmentList() {
        initComponents();
    }
    
    public MakeAppointmentList(String ID,JFrame Frame,JLabel Label,JLabel Label2,JLabel Label3,JComboBox Combo,String First) {
        initComponents();
        id=ID;
        frame=Frame;
        label=Label;
        ...
        MakeAppointmentList close=this;
    ...
    private void jSelectMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSelectMouseClicked
        ...
        MakeAppointment appointment = new MakeAppointment(id,ID);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MakeAppointmentList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MakeAppointmentList().setVisible(true);
            }
        });
    }
