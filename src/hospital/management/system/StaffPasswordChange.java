 ...
 * @author Pavi
 */
public class StaffPasswordChange extends javax.swing.JFrame {
    String id;
    String job;
    /**
     * Creates new form StaffPasswordChange
     */
    public StaffPasswordChange() {
        initComponents();
    }
    
    public StaffPasswordChange(String ID) {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jChangePassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 410, -1, -1));
        ...
        getContentPane().add(jBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 410, -1, -1));
    ...
    private void jChangePasswordMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jChangePasswordMouseClicked
        ...
        ResultSet rs = null;
        con = Link.getConnection();
        String sql="select * from staff where id=? and username=? and password=?";
        try{
            st=con.prepareStatement(sql);
            st.setString(1,id);
            ...
            if(rs.next()){
                if(new_password.equals(conf_new_password)){
                    ...
                    String sql1="update staff set password=? where id='"+id+"'";
                    try{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StaffPasswordChange.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StaffPasswordChange().setVisible(true);
            }
        });
    }
