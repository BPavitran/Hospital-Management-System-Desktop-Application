 ...
 * @author Pavi
 */
public class DoctorProfileUpdate extends javax.swing.JFrame {
    String filename;
    byte[] person_image;
    byte[] imageBytes;
    String id;
    int check=0;
    /**
     * Creates new form DoctorProfileUpdate2
     */
    public DoctorProfileUpdate() {
        initComponents();
    }
    
    public DoctorProfileUpdate(String ID){
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 490, -1, -1));
    ...
    private void jSubmitMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSubmitMouseClicked
        ...
        PreparedStatement st=null;
        con=Link.getConnection();
        String sql="update doctor set photo=? where id='"+id+"'";
        try{
            st=con.prepareStatement(sql);
    ...
    private void jViewProfileMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jViewProfileMouseClicked
        // TODO add your handling code here:
        DoctorProfileView view = new DoctorProfileView(id);
    ...
    private void jUpdateProfileMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jUpdateProfileMouseClicked
        // TODO add your handling code here:
        DoctorProfileUpdate view = new DoctorProfileUpdate(id);
        view.setVisible(true);
        dispose();
    ...
    private void jSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSaveMouseClicked
        ...
        PreparedStatement st=null;
        con=Link.getConnection();
        String sql="update doctor set name=?,surname=?,age=?,specialization=?,gender=?,blood=?,address=?,city=?,phone=?,NIC=?,email=?,joining=?,full_name=? where id='"+id+"'";
        try{
            st=con.prepareStatement(sql);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DoctorProfileUpdate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DoctorProfileUpdate().setVisible(true);
            }
        });
    }
