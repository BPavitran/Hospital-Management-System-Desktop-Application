 ...
 * @author Pavi
 */
public class WardPatientList extends javax.swing.JFrame {
    String id;
    JFrame frame;
    JLabel label;
    JLabel label2;
    JLabel label3;
    /**
     * Creates new form WardPatientList
     */
    public WardPatientList() {
        initComponents();
    }
    
    public WardPatientList(String ID,JFrame Frame,JLabel Label,JLabel Label2,JLabel Label3) {
        initComponents();
        id=ID;
        frame=Frame;
        label=Label;
        ...
        String sql="select name,surname,phone from patient where id in (select patient_id from patient_stage where patient_type=?)";
        try{
    ...
    private void jSelectMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSelectMouseClicked
        ...
        WardPatient patient = new WardPatient(id,ID);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WardPatientList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WardPatientList().setVisible(true);
            }
        });
    }
