...
public class AdminProfileUpdate extends javax.swing.JFrame {
    ...
    public AdminProfileUpdate(String ID){
        initComponents();
    ...
    private void jSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSaveMouseClicked
        ...
        PreparedStatement st=null;
        con=Link.getConnection();
        String sql="update admin set name=?,surname=?,age=?,job=?,gender=?,blood=?,address=?,city=?,phone=?,NIC=?,email=?,joining=?,full_name=? where id='"+id+"'";
        try{
            st=con.prepareStatement(sql);
    ...
    private void jSubmitMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jSubmitMouseClicked
        ...
        PreparedStatement st=null;
        con=Link.getConnection();
        String sql="update admin set photo=? where id='"+id+"'";
        try{
            st=con.prepareStatement(sql);
    ...
    private void jUpdateProfileMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jUpdateProfileMouseClicked
        // TODO add your handling code here:
        AdminProfileUpdate view = new AdminProfileUpdate(id);
        view.setVisible(true);
        dispose();
