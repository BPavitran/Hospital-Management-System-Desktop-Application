 ...
 * @author Pavi
 */
public class DoctorPasswordChange extends javax.swing.JFrame {
    String id;
    /**
     * Creates new form DoctorPasswordChange
     */
    public DoctorPasswordChange() {
        initComponents();
    }
    
    public DoctorPasswordChange(String ID) {
        initComponents();
    ...
    private void jChangePasswordMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jChangePasswordMouseClicked
        ...
        String sql="select * from doctor where id=? and username=? and password=?";
        try{
            ...
            if(rs.next()){
                if(new_password.equals(conf_new_password)){
                    ...
                    String sql1="update doctor set password=? where id='"+id+"'";
                    try{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DoctorPasswordChange.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DoctorPasswordChange().setVisible(true);
            }
        });
    }
